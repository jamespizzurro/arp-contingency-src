...
/////
	...
	// Contingency - James
	// Start fading out ragdolls a specified amount of time after they spawn
	// The duration of the delay is defined by the constant float RAGDOLL_FADE_OUT_DELAY in c_baseanimating.cpp

	// Defines the amount of time after a ragdoll spawns
	// before it starts fading out and is ultimately removed
...
/////
	...
	// After the fade out is complete, the ragdoll
	// is entirely removed from the map
