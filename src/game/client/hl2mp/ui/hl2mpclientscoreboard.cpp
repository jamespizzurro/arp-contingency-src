...
/////
	...
	// Contingency - James
	// Change the color of the scoreboard from yellow to grey

	//m_borderColor = pScheme->GetColor( "FgColor", Color( 0, 0, 0, 0 ) );

	m_borderColor = COLOR_GREY;
...
/////
	...
	// Change the color of the scoreboard from yellow to grey
		...
		m_pPlayerCountLabel_DM->SetFgColor( COLOR_GREY );
		m_pScoreHeader_DM->SetFgColor( COLOR_GREY );
		m_pDeathsHeader_DM->SetFgColor( COLOR_GREY );
		m_pPingHeader_DM->SetFgColor( COLOR_GREY );
		m_pPingLabel_DM->SetFgColor( COLOR_GREY );
