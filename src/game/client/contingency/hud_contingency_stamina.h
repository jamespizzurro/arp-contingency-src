#if !defined( HUD_CONTINGENCY_STAMINA_H )
#define HUD_CONTINGENCY_STAMINA_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CHudContingencyStamina : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHudContingencyStamina, vgui::Panel );

public:
	CHudContingencyStamina( const char *pElementName );
...
#endif // HUD_CONTINGENCY_STAMINA_H
