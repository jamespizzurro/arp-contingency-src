...
#include "hud_contingency_stamina.h"
...
DECLARE_HUDELEMENT( CHudContingencyStamina );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHudContingencyStamina::CHudContingencyStamina( const char *pElementName ) : CHudElement( pElementName ), BaseClass( NULL, "HudContingencyStamina" )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHudContingencyStamina::Init( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHudContingencyStamina::Reset( void )
{
	Init();
}
...
//-----------------------------------------------------------------------------
bool CHudContingencyStamina::ShouldDraw()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHudContingencyStamina::OnThink( void )
{
...
//-----------------------------------------------------------------------------
void CHudContingencyStamina::Paint()
{
	C_BaseHLPlayer *pPlayer = (C_BaseHLPlayer *)C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
		return;
	...
	wchar_t *tempString = g_pVGuiLocalize->Find("#Contingency_HUD_AUX_Power");
