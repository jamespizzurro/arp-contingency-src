...
public:
static const int EXPLOSION_RADIUS = 200; //AI Patch Addition
	static const int EXPLOSION_DAMAGE = 200; //AI Patch Addition
	CMissile();
	~CMissile();
	...
	void CreateDangerSounds( bool bState ){ m_bCreateDangerSounds = bState; } //AI Patch Addition
...
protected:
	...
	struct CustomDetonator_t //AI Patch Addition
	{ //AI Patch Addition
		EHANDLE hEntity; //AI Patch Addition
		float radiusSq; //AI Patch Addition
		float halfHeight; //AI Patch Addition
	}; //AI Patch Addition

	static CUtlVector<CustomDetonator_t> gm_CustomDetonators; //AI Patch Addition


private:
	float					m_flGracePeriodEndsAt;
	bool					m_bCreateDangerSounds; //AI Patch Addition
...
public:
	...
	void	APCSeekThink( void ); //AI Patch Addition
...
public:
	...
	bool	WeaponLOSCondition( const Vector &ownerPos, const Vector &targetPos, bool bSetConditions ); //AI Patch Addition
	int		WeaponRangeAttack1Condition( float flDot, float flDist ); //AI Patch Addition
...
#endif //AI Patch Addition
	virtual const Vector& GetBulletSpread( void ) //AI Patch Addition
	{ //AI Patch Addition
		static Vector cone = VECTOR_CONE_3DEGREES; //AI Patch Addition
		return cone; //AI Patch Addition
	} //AI Patch Addition
