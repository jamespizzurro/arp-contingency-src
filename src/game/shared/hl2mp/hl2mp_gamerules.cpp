...
/////
	...
	// Contingency - James
	// Do not allow custom gamerules proxy to be deleted on a map cleanup

	"contingency_gamerules",
...
/////
	...
	// Contingency - James
	// Added wave system
	// Do not allow custom configuration entity to be deleted on a map cleanup
	// as it won't come back after doing so and keeping it around does no harm
