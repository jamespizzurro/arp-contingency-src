...
extern int g_interactionPlayerLaunchedRPG; //AI Patch Addition
#endif
...
BEGIN_DATADESC( CMissile )
	...
	DEFINE_FIELD( m_bCreateDangerSounds,	FIELD_BOOLEAN ), //AI Patch Addition
...
{
	m_hRocketTrail = NULL;
	m_bCreateDangerSounds = false; //AI Patch Addition
}
...
void CMissile::Spawn( void )
{
	...
	SetDamage( EXPLOSION_DAMAGE ); //AI Patch Addition
...
{
	// Explode
	ExplosionCreate( GetAbsOrigin(), GetAbsAngles(), GetOwnerEntity(), GetDamage(), CMissile::EXPLOSION_RADIUS, //AI Patch Addition
...
void CMissile::MissileTouch( CBaseEntity *pOther )
{
	...
	{ //AI Patch Addition
		// Some NPCs are triggers that can take damage (like antlion grubs). We should hit them. //AI Patch Addition
		if ( ( pOther->m_takedamage == DAMAGE_NO ) || ( pOther->m_takedamage == DAMAGE_EVENTS_ONLY ) ) //AI Patch Addition
			return;
	} //AI Patch Addition
...
if( flBestDist <= ( GetAbsVelocity().Length() * 2.5f ) && FVisible( pBestDot->GetAbsOrigin() ) ) //AI Patch Addition
	{ //AI Patch Addition
		// Scare targets //AI Patch Addition
		CSoundEnt::InsertSound( SOUND_DANGER, pBestDot->GetAbsOrigin(), CMissile::EXPLOSION_RADIUS, 0.2f, pBestDot, SOUNDENT_CHANNEL_REPEATED_DANGER, NULL ); //AI Patch Addition
	} //AI Patch Addition
...
if( pLaserDot->GetTargetEntity() != NULL && flDist <= 240.0f ) //AI Patch Addition
	{ //AI Patch Addition
		// Prevent the missile circling the Strider like a Halo in ep1_c17_06. If the missile gets within 20 //AI Patch Addition
		// feet of a Strider, tighten up the turn speed of the missile so it can break the halo and strike. (sjb 4/27/2006) //AI Patch Addition
		if( pLaserDot->GetTargetEntity()->ClassMatches( "npc_strider" ) ) //AI Patch Addition
		{ //AI Patch Addition
			flHomingSpeed *= 1.75f; //AI Patch Addition
		} //AI Patch Addition
	} //AI Patch Addition
	...
	// Think as soon as possible
	SetNextThink( gpGlobals->curtime );
	if ( m_bCreateDangerSounds == true ) //AI Patch Addition
	{ //AI Patch Addition
		trace_t tr; //AI Patch Addition
		UTIL_TraceLine( GetAbsOrigin(), GetAbsOrigin() + GetAbsVelocity() * 0.5, MASK_SOLID, this, COLLISION_GROUP_NONE, &tr ); //AI Patch Addition

		CSoundEnt::InsertSound( SOUND_DANGER, tr.endpos, 100, 0.2, this, SOUNDENT_CHANNEL_REPEATED_DANGER ); //AI Patch Addition
	} //AI Patch Addition
}
...
DEFINE_THINKFUNC( APCSeekThink ), //AI Patch Addition
...
void CAPCMissile::Init()
{
	...
	CreateDangerSounds( true ); //AI Patch Addition


	if( g_pGameRules->GetAutoAimMode() == AUTOAIM_ON_CONSOLE ) //AI Patch Addition
	{ //AI Patch Addition
		AddFlag( FL_AIMTARGET ); //AI Patch Addition
	} //AI Patch Addition
}
...
acttable_t	CWeaponRPG::m_acttable[] = 
{
	...
	{ ACT_IDLE_RELAXED,				ACT_IDLE_RPG_RELAXED,			true }, //AI Patch Addition
	{ ACT_IDLE_STIMULATED,			ACT_IDLE_ANGRY_RPG,				true }, //AI Patch Addition
	{ ACT_IDLE_AGITATED,			ACT_IDLE_ANGRY_RPG,				true }, //AI Patch Addition

	{ ACT_IDLE,						ACT_IDLE_RPG,					true }, //AI Patch Addition
	{ ACT_IDLE_ANGRY,				ACT_IDLE_ANGRY_RPG,				true }, //AI Patch Addition
	{ ACT_WALK,						ACT_WALK_RPG,					true }, //AI Patch Addition
	{ ACT_WALK_CROUCH,				ACT_WALK_CROUCH_RPG,			true }, //AI Patch Addition
	{ ACT_RUN,						ACT_RUN_RPG,					true }, //AI Patch Addition
	{ ACT_RUN_CROUCH,				ACT_RUN_CROUCH_RPG,				true }, //AI Patch Addition
	{ ACT_COVER_LOW,				ACT_COVER_LOW_RPG,				true }, //AI Patch Addition
};
...
CWeaponRPG::CWeaponRPG()
{
	...
	m_bGuiding = false;
m_hMissile = NULL; //AI Patch Addition
...
void CWeaponRPG::ItemPostFrame( void )
{
	...
	if ( pPlayer->m_afButtonPressed & IN_ATTACK2 ) //AI Patch Addition.
	{ //AI Patch Addition
		ToggleGuiding(); //AI Patch Addition
	} //AI Patch Addition
}
...
{ 
m_vecLaserDot = vecTarget; //AI Patch Addition
}
...
{
	return m_vecLaserDot; //AI Patch Addition.
}
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CWeaponRPG::Holster( CBaseCombatWeapon *pSwitchingTo ) //AI Patch Addition
{ //AI Patch Addition
	StopGuiding(); //AI Patch Addition
	return BaseClass::Holster( pSwitchingTo ); //AI Patch Addition
} //AI Patch Addition
