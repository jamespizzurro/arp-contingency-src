...
#define GAMEMOVEMENT_JUMP_TIME				510.0f		//ms approx - based on the 21 unit height jump - normally 510.0f
#define GAMEMOVEMENT_JUMP_HEIGHT			45.0f		//ModificationMovement Addition: Original is 21.0f units
