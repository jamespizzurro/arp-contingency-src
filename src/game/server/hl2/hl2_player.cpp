...
/////
	...
	#define	HL2_WALK_SPEED CONTINGENCY_WALK_SPEED
	#define	HL2_NORM_SPEED CONTINGENCY_NORM_SPEED
	#define	HL2_SPRINT_SPEED CONTINGENCY_SPRINT_SPEED
...
/////
	...
	// Contingency - James
	// Disable suit zooming (HUD zoom) functionality
...
/////
	...
	// Contingency - James
	// Disable default health display functionality
