...
{
	/*if ( HL2GameRules()->IsAlyxInDarknessMode() ) // AI Patch Addition.
	{ // AI Patch Addition.
		CSoundEnt::InsertSound( SOUND_COMBAT, EyePosition(), volume, duration, this, SOUNDENT_CHANNEL_SPOOKY_NOISE ); // AI Patch Addition.
	}*/ // AI Patch Addition.
}
