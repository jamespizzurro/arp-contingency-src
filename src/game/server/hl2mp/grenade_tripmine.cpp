...
/////
	...
	// Contingency - James
	// Fix an annoying crashing bug having to do with the SLAM tripmine taking damage

	// Well would you look at that, it's caused by the AI patch...
	// Use your own code kids! Don't do what I do!
